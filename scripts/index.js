(async () => {
	...
	document.getElementById("print").onclick = () => {
		cursor = [-1, -1];
		render();
		let a = document.getElementById("viewport");
		...
		d.classList.add("c");
		d.innerText = "Horizontal";
		c.appendChild(d);
		let e = document.createElement("p");
		e.classList.add("clue");
		e.classList.add("c");
		e.innerText = "Vertical";
		c.appendChild(e);
		let f = document.createElement("div");
		c.classList.add("side");
		let g = document.createElement("p");
		g.classList.add("clue");
		g.innerText = document.getElementById("h-clues").value;
		f.appendChild(g);
		let h = document.createElement("p");
		h.classList.add("clue");
		h.innerText = document.getElementById("v-clues").value;
		f.appendChild(h);
